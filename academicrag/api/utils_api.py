"""
Utility functions for the AcademicRAG API.
"""
...
class OllamaServerInfos:
    ...
    ACADEMICRAG_NAME = "academicrag"
    ACADEMICRAG_TAG = os.getenv("OLLAMA_EMULATING_MODEL_TAG", "latest")
    ACADEMICRAG_MODEL = f"{ACADEMICRAG_NAME}:{ACADEMICRAG_TAG}"
    ACADEMICRAG_SIZE = 7365960935  # it's a dummy value
    ACADEMICRAG_CREATED_AT = "2024-01-15T00:00:00Z"
    ACADEMICRAG_DIGEST = "sha256:academicrag"
