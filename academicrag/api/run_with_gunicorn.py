#!/usr/bin/env python
"""
Start AcademicRAG server with Gunicorn
"""
...
from academicrag.api.utils_api import parse_args, display_splash_screen
from academicrag.kg.shared_storage import initialize_share_data, finalize_share_data
...
def main():
    ...
    print("🚀 Starting AcademicRAG with Gunicorn")
    ...
    class GunicornApp(BaseApplication):
        ...
        def load_config(self):
            ...
            from academicrag.api import gunicorn_config
        ...
        def load(self):
            ...
            from academicrag.api.academicrag_server import get_application
    ...
    if workers_count > 1:
        ...
        os.environ["ACADEMICRAG_MAIN_PROCESS"] = "1"
