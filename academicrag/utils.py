...
import numpy as np
import tiktoken
from academicrag.prompt import PROMPTS
...
class AcademicragPathFilter(logging.Filter):
    """Filter for academicrag logger to filter out frequent path access logs"""
...
def setup_logger(
    ...
    Args:
        ...
        add_filter: Whether to add AcademicragPathFilter to the logger
        log_file_path: Path to the log file. If None and file logging is enabled, defaults to academicrag.log in LOG_DIR or cwd
    ...
    if add_filter:
        path_filter = AcademicragPathFilter()
...
def check_storage_env_vars(storage_name: str) -> None:
    ...
    """
    from academicrag.kg import STORAGE_ENV_REQUIREMENTS
